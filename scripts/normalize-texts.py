...
def dividir_conteudo(conteudo, max_length=1024):
    ...
    """
    # Dividir o conteúdo em palavras e reconstruir para garantir que não estamos cortando palavras ao meio
...
output_path = "env/docs-json/docs.json"  # Certifique-se de incluir o nome do arquivo JSON
